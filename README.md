...
Try It Online at the [FlipJump IDE](https://fj.tomhe.app/), and read more at the [**FlipJump Docs**](https://fjdocs.tomhe.app/).
...
- Find zeroing loops, and replace them with `*ptr = 0`. If there are data-ops before it, remove them too.
- `*ptr = 0` + `+5` => `*ptr = 5`.
